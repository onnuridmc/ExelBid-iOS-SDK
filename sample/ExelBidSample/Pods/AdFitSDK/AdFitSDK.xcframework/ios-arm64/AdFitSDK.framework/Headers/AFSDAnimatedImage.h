 ...
 */
- (nullable instancetype)initWithData:(nonnull NSData *)data scale:(CGFloat)scale options:(nullable AFSDImageCoderOptions *)options;
 ...
 */
@interface AFSDAnimatedImage : UIImage <AFSDAnimatedImage>
 ...
 */
//sdk @property (nonatomic, assign, readonly) SDImageFormat animatedImageFormat;
