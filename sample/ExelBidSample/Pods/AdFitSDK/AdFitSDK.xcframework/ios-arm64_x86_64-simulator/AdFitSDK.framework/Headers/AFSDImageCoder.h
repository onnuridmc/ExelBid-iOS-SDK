...
//sdk #import "NSData+ImageContentType.h"
typedef NSInteger AFSDImageFormat NS_TYPED_EXTENSIBLE_ENUM; //sdk
typedef NSString * AFSDImageCoderOption NS_STRING_ENUM;
typedef NSDictionary<AFSDImageCoderOption, id> AFSDImageCoderOptions;
typedef NSMutableDictionary<AFSDImageCoderOption, id> AFSDImageCoderMutableOptions;
 ...
 */
FOUNDATION_EXPORT AFSDImageCoderOption _Nonnull const AFSDImageCoderDecodeFirstFrameOnly;
 ...
 */
FOUNDATION_EXPORT AFSDImageCoderOption _Nonnull const AFSDImageCoderDecodeScaleFactor;
...
/**
 ...
 @note works for `SDImageCoder`, `SDProgressiveImageCoder`, `SDAnimatedImageCoder`.
 */
FOUNDATION_EXPORT AFSDImageCoderOption _Nonnull const AFSDImageCoderDecodePreserveAspectRatio;
...
/**
 ...
 @note works for `SDImageCoder`, `SDProgressiveImageCoder`, `SDAnimatedImageCoder`.
 */
FOUNDATION_EXPORT AFSDImageCoderOption _Nonnull const AFSDImageCoderDecodeThumbnailPixelSize;
...
/**
 ...
 @note works for `SDImageCoder`.
 */
FOUNDATION_EXPORT AFSDImageCoderOption _Nonnull const AFSDImageCoderEncodeFirstFrameOnly;
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT AFSDImageCoderOption _Nonnull const AFSDImageCoderEncodeCompressionQuality;
...
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT AFSDImageCoderOption _Nonnull const AFSDImageCoderEncodeBackgroundColor;
...
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT AFSDImageCoderOption _Nonnull const AFSDImageCoderEncodeMaxPixelSize;
...
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT AFSDImageCoderOption _Nonnull const AFSDImageCoderEncodeMaxFileSize;
...
/**
 ...
 @note works for `SDImageCoder`
 */
FOUNDATION_EXPORT AFSDImageCoderOption _Nonnull const AFSDImageCoderEncodeEmbedThumbnail;
 ...
 */
FOUNDATION_EXPORT AFSDImageCoderOption _Nonnull const AFSDImageCoderWebImageContext API_DEPRECATED("The coder component will be seperated from Core subspec in the future. Update your code to not rely on this context option.", macos(10.10, API_TO_BE_DEPRECATED), ios(8.0, API_TO_BE_DEPRECATED), tvos(9.0, API_TO_BE_DEPRECATED), watchos(2.0, API_TO_BE_DEPRECATED));
 ...
 */
@protocol AFSDImageCoder <NSObject>
...
- (nullable UIImage *)decodedImageWithData:(nullable NSData *)data
                                   options:(nullable AFSDImageCoderOptions *)options;
 ...
 */
 - (BOOL)canEncodeToFormat:(AFSDImageFormat)format NS_SWIFT_NAME(canEncode(to:));
 ...
 */
- (nonnull instancetype)initIncrementalWithOptions:(nullable AFSDImageCoderOptions *)options;
 ...
 */
- (nullable UIImage *)incrementalDecodedImageWithOptions:(nullable AFSDImageCoderOptions *)options;
 ...
 */
- (nullable instancetype)initWithAnimatedImageData:(nullable NSData *)data options:(nullable AFSDImageCoderOptions *)options;
