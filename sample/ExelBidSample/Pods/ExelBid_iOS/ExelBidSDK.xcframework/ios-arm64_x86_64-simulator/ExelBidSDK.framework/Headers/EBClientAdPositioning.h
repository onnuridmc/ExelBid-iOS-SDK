...
/**
 * The `EBClientAdPositioning` class is a model that allows you to control the positions where
 ...
 *
 * Unlike with `EBServerAdPositioning`, which tells an ad placer to obtain its positioning
 * information from the ExelBid ad server, client ad positioning does not allow you to control your ad
 * positions via the ExelBid website.
 */

@interface EBClientAdPositioning : EBAdPositioning
