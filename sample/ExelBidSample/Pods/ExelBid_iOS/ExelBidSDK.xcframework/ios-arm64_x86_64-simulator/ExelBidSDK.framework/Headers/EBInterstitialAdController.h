...
/**
 * The `EBInterstitialAdController` class provides a full-screen advertisement that can be
...
/**
 * The delegate (`EBInterstitialAdControllerDelegate`) of the interstitial ad object.
 */
@property (nonatomic, weak) id<EBInterstitialAdControllerDelegate> delegate;

/** @name Setting Request Parameters */

/**
 * The Exelbid ad unit ID for this interstitial ad.
 *
 ...
 * `EBInterstitialAdControllerDelegate` if you would like to be notified as loading succeeds or
 * fails.
 */
- (void)loadAd;
 ...
 * third-party ad networks. See `EBInterstitialAdControllerDelegate` for more details.
 */
 ...
 *
 * `EBInterstitialAdControllerDelegate` provides optional methods that you may implement to stay
 ...
 */
+ (void)removeSharedInterstitialAdController:(EBInterstitialAdController *)controller;
...
/**
 * The delegate of an `EBInterstitialAdController` object must adopt the
 * `EBInterstitialAdControllerDelegate` protocol.
 *
...
@protocol EBInterstitialAdControllerDelegate <NSObject>
