...
/**
 * The `EBCollectionViewAdPlacer` class allows you to request native ads from the ExelBid ad server
...
@property (nonatomic, weak) id<EBCollectionViewAdPlacerDelegate> delegate;
 ...
 *
 * @return An `EBCollectionViewAdPlacer` object.
 */
 ...
 * @return An `EBCollectionViewAdPlacer` object.
 */
+ (instancetype)placerWithCollectionView:(UICollectionView *)collectionView viewController:(UIViewController *)controller adPositioning:(EBAdPositioning *)positioning rendererConfigurations:(NSArray *)rendererConfigurations;
...
/**
 * The ExelBid SDK adds interfaces to the `UICollectionView` class to help your application with
 * responsibilities related to `EBCollectionViewAdPlacer`. These APIs include methods to help notify
...
@interface UICollectionView (EBCollectionViewAdPlacer)

- (void)EB_setAdPlacer:(EBCollectionViewAdPlacer *)placer;
 ...
 */
- (EBCollectionViewAdPlacer *)EB_adPlacer;
 ...
 */
- (void)EB_setDataSource:(id<UICollectionViewDataSource>)dataSource;
 ...
 */
- (id<UICollectionViewDataSource>)EB_dataSource;
 ...
 */
- (void)EB_setDelegate:(id<UICollectionViewDelegate>)delegate;
 ...
 */
- (id<UICollectionViewDelegate>)EB_delegate;
 ...
 */
- (void)EB_insertItemsAtIndexPaths:(NSArray *)indexPaths;
 ...
 * `nil`.
 */
- (void)EB_deleteItemsAtIndexPaths:(NSArray *)indexPaths;
 ...
 */
- (void)EB_reloadItemsAtIndexPaths:(NSArray *)indexPaths;
 ...
 */
- (void)EB_moveItemAtIndexPath:(NSIndexPath *)indexPath toIndexPath:(NSIndexPath *)newIndexPath;
 ...
 */
- (void)EB_insertSections:(NSIndexSet *)sections;
 ...
 */
- (void)EB_deleteSections:(NSIndexSet *)sections;
 ...
 */
- (void)EB_reloadSections:(NSIndexSet *)sections;
 ...
 */
- (UICollectionViewCell *)EB_cellForItemAtIndexPath:(NSIndexPath *)indexPath;
 ...
 */
- (id)EB_dequeueReusableCellWithReuseIdentifier:(NSString *)identifier forIndexPath:(NSIndexPath*)indexPath;
 ...
 */
- (void)EB_deselectItemAtIndexPath:(NSIndexPath *)indexPath animated:(BOOL)animated;
 ...
 * collection view.
 */
- (NSIndexPath *)EB_indexPathForCell:(UICollectionViewCell *)cell;
 ...
 */
- (NSIndexPath *)EB_indexPathForItemAtPoint:(CGPoint)point;
 ...
 */
- (NSArray *)EB_indexPathsForSelectedItems;
 ...
 */
- (NSArray *)EB_indexPathsForVisibleItems;
 ...
 */
- (UICollectionViewLayoutAttributes *)EB_layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath;
 ...
 */
- (void)EB_scrollToItemAtIndexPath:(NSIndexPath *)indexPath atScrollPosition:(UICollectionViewScrollPosition)scrollPosition animated:(BOOL)animated;
 ...
 * finishes.
 */
- (void)EB_selectItemAtIndexPath:(NSIndexPath *)indexPath animated:(BOOL)animated scrollPosition:(UICollectionViewScrollPosition)scrollPosition;
...
@protocol EBCollectionViewAdPlacerDelegate <NSObject>
