...
#import <ExelBidSDK/EBNativeAd.h>

@class EBNativeAdRenderingImageLoader;

/**
 * The EBNativeAdRendering protocol provides methods for displaying ad content in
 * custom view classes.
 *
...
@protocol EBNativeAdRendering <NSObject>
 ...
 */
- (void)layoutCustomAssetsWithProperties:(NSDictionary *)customProperties imageLoader:(EBNativeAdRenderingImageLoader *)imageLoader;
