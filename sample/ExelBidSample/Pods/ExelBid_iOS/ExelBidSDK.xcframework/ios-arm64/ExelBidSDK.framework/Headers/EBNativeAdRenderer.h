 ...
 */
typedef CGSize (^EBNativeViewSizeHandler)(CGFloat maximumWidth);

/**
 * The ExelBid SDK has a concept of native ad renderer that allows you to render the ad however you want. It also gives you the
 ...
 */
@protocol EBNativeAdRenderer <NSObject>

@required

/**
 * You must construct and return an EBNativeAdRendererConfiguration object specific for your renderer. You must
 ...
 * construct.
 *
 * @return A configuration object that allows the ExelBid SDK to instantiate your renderer with the application
...
/**
 * This is the init method that will be called when the ExelBid SDK initializes your renderer.
 *
 * @param rendererSettings The renderer settings object that corresponds to your renderer.
 */
- (instancetype)initWithRendererSettings:(id<EBNativeAdRendererSettings>)rendererSettings;
 ...
 */
- (UIView *)retrieveViewWithAdapter:(id<EBNativeAdAdapter>)adapter error:(NSError **)error;
...
/**
 * The ExelBidSDK will notify your renderer when your native ad's view has moved in
...
/**
 *
 * The ExelBidSDK will call this method when the user has tapped the ad and will
