...
@implementation EBNativeDialogView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIView *adBackView = [[UIView alloc] initWithFrame:CGRectMake(20, (frame.size.height-440)/2, frame.size.width-40, 440)];
        ...
        self.closeButton = [[UIButton alloc] initWithFrame:CGRectMake(10, adBackView.frame.size.height - 55, adBackView.frame.size.width/2 - 20, 50)];
        ...
        self.cancleButton = [[UIButton alloc] initWithFrame:CGRectMake(adBackView.frame.size.width/2+10, adBackView.frame.size.height - 55, adBackView.frame.size.width/2 - 20, 50)];
